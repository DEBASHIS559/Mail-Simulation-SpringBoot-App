...
public class MailService {
	...
	public ResponseEntity<ResponseStructure<List<Mail>>> viewDraftItem(String email){
		User fromUser = userDao.getUserByEmail(email);
	...
	public ResponseEntity<ResponseStructure<String>> editDraftMail(String email,int mailid,
			MailDto mailDto) {
		User fromUser = userDao.getUserByEmail(email);
